...
Framework7.prototype.plugins.settings = function (app, globalPluginParams) {
    ...
    Settings_loc = function (options) {
                        ...
                        '<li>' +
                            '<div class="item-content">' +
                                '<div class="item-media">' +
                                    '<i class="icon icon-sounds active" id="icon-sounds"></i>' +
                                '</div>' +
                                '<div class="item-inner">' +
                                    '<div class="item-title label"><script>document.write(_w.settings[LN].sounds);</script></div>' +
        ...
        function compileTemplate() {
            if (!options.template) {
                // Cache compiled templates
                if (!app._compiledTemplates.exercises) {
                    app._compiledTemplates.exercises = t7.compile(defaultTemplate);
                }
                template = app._compiledTemplates.exercises;
...
var mainView = myApp.addView('.view-main', fw7ViewOptions),
    ...
    achievementsView = myApp.addView('.view-achievements', fw7ViewOptions);
    ...
    document.addEventListener("DOMContentLoaded", function(event) {
        ...
        (function(){
            ...
            if(localStorage.getItem(n.key_storage.categories)){
                ...
                if(storage.settings.notification){
                    createNotification();
                }
                else{
            ...
            // sounds
            n.sounds.achiev = new Sound('sound/achieve.mp3');
            n.sounds.achiev.volume(0.5);
            n.sounds.tap = new Sound('sound/tap.mp3');
